...
| `scan_decode_retry_mm` | `5.0` | Extra jog distance after an incomplete rich tag read |
| `scan_decode_retries` | `3` | Maximum rich-read retry jogs before accepting the current result |
